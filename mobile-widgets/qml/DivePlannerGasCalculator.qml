                ...
                onClicked: {
                    ...
                    switch (modeSelector.currentIndex) {
                        case 0: // MOD
                            ...
                            results = Backend.gasBlenderModel.calculateGasInfo(typeBox.currentText, o2Box.value * 10, heBox.value * 10);
                            break;
                        ...
                        case 2: // Full Blending
                            ...
                            if (modeSelector.currentIndex === 1) {
                                results = Backend.gasBlenderModel.calculateCheapestBlend(targetCylinderSize.currentText,targetStartMix.text, targetStartPressure.value, targetEndMix.text, targetEndPressure.value, availableGases, true);
                            } else {
                                results = Backend.gasBlenderModel.calculateCheapestBlend(targetCylinderSize.currentText, targetStartMix.text, targetStartPressure.value, targetEndMix.text, targetEndPressure.value, availableGases, false);
                            }
                            break;
                    }
