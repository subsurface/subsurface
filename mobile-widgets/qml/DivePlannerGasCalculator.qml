...
TemplatePage {
    ...
    Component.onCompleted: {
        // Default examples
        gasListModel.append({ "mix": "0/100", "pressure": (Backend.pressure === Enums.BAR) ? "200" : "3000", "amount": "UNLIMITED", "cost": "1.00", "boost": false});
        gasListModel.append({ "mix": "100/0", "pressure": (Backend.pressure === Enums.BAR) ? "200" : "3000", "amount": "UNLIMITED", "cost": "0.50", "boost": false });
    ...
    Flickable {
        ...
        ColumnLayout {
            ...
            GridLayout {
                ...
                SsrfTextField { id: targetStartMix; text: "21/0"; Layout.fillWidth: true }
                ...
                SsrfTextField { id: targetEndMix; text: "32/0"; Layout.fillWidth: true }
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    // Drag handle + Index (combined space)
                    Item { Layout.preferredWidth: Kirigami.Units.gridUnit * 2.5 } 
                    
                    Controls.Label { 
                        text: qsTr("Cyl"); // Shortened "Cylinder" to save space
                        font.bold: true; 
                    ...
                    Controls.Label { 
                        text: qsTr("Bst"); // "Bst" for Boost
                        font.bold: true; 
                        Layout.preferredWidth: Kirigami.Units.gridUnit * 1.5; 
                        visible: modeSelector.currentIndex === 2 
                    }
                    Controls.Label { 
                        text: "[%1]".arg(pressureUnit); 
                        font.bold: true; 
                    ...
                    Item { Layout.preferredWidth: Kirigami.Units.iconSizes.small } // Delete button spacer
                }
                    ...
                    delegate: DropArea {
                        ...
                        Item {
                            ...
                            RowLayout {
                                ...
                                // Drag Handle & Index (2.5 units total)
                                Item {
                                    Layout.preferredWidth: Kirigami.Units.gridUnit * 1.5
                                    Layout.fillHeight: true
                                    Text { text: "≡"; anchors.centerIn: parent }
                                    MouseArea { id: dragMouseArea; anchors.fill: parent; cursorShape: Qt.OpenHandCursor }
                                }
                                Controls.Label { 
                                    text: index + 1; 
                                ...
                                // Cylinder Combo (Matches 5.5 header)
                                TemplateComboBox { 
                                    id: cylinderSize
                                    Layout.preferredWidth: Kirigami.Units.gridUnit * 5.5
                                    visible: modeSelector.currentIndex === 2
                                    ...
                                    onActivated: gasListModel.setProperty(modelIndex, "amount", textAt(index))
                                }

                                // Mix (Fills remaining space)
                                SsrfTextField { text: mix; onTextChanged: gasListModel.setProperty(index, "mix", text); Layout.fillWidth: true }

                                // Boost (Matches 1.5 header)
                                TemplateCheckBox { 
                                    checked: boost; 
                                ...
                                // Pressure (Matches 2.5 header)
                                SsrfTextField { 
                                    text: pressure; 
                                    onTextChanged: gasListModel.setProperty(index, "pressure", text); 
                                    Layout.preferredWidth: Kirigami.Units.gridUnit * 2.5; 
                                    visible: modeSelector.currentIndex === 2 
                                }

                                // Cost (Matches 2.5 header)
                                SsrfTextField { 
                                    text: cost; 
                                    onTextChanged: gasListModel.setProperty(index, "cost", text); 
                                    Layout.preferredWidth: Kirigami.Units.gridUnit * 2.5; 
                                    visible: modeSelector.currentIndex > 0 
                                }
