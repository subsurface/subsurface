...
if(BUILD_DOCS)
	# The Documentation directory has a hand-written GNU Makefile (not
	# generated by cmake), so we must invoke `make` explicitly rather
	# than ${CMAKE_MAKE_PROGRAM} which would be `ninja` when building
	# with -G Ninja and would fail looking for build.ninja.
	find_program(MAKE_COMMAND NAMES make gmake)
	if(NOT MAKE_COMMAND)
		message(FATAL_ERROR "BUILD_DOCS is ON but make/gmake was not found")
	endif()
	add_custom_target(
		build_documentation ALL
		COMMAND
		${MAKE_COMMAND} -C ${CMAKE_SOURCE_DIR}/Documentation doc
	)
