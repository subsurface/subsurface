...
class qPrefFacebook : public QObject {
	Q_OBJECT
	Q_PROPERTY(QString access_token READ accessToken WRITE setAccessToken NOTIFY accessTokenChanged);
	Q_PROPERTY(QString album_id READ albumId WRITE setAlbumId NOTIFY albumIdChanged);
