...
class qPrefDisplay : public QObject {
	...
	Q_PROPERTY(bool invalid_dives READ displayInvalidDives WRITE setDisplayInvalidDives NOTIFY displayInvalidDivesChanged);
	Q_PROPERTY(bool show_developer READ showDeveloper WRITE setShowDeveloper NOTIFY showDeveloperChanged);
