...
static QMap<color_index_t, std::array<QColor, 2>> profile_color = {
	...
	{ VELO_STABLE, {{ BLACK1, BLACK1_LOW_TRANS }} },
	{ VELO_SLOW, {{ BLACK1, BLACK1_LOW_TRANS }} },
	...
	{ SAMPLE_DEEP, {{ BLACK1, BLACK1 }} },
	{ SAMPLE_SHALLOW, {{ BLACK1, BLACK1_LOW_TRANS }} },
	...
	{ DEPTH_BOTTOM, {{ WHITE1, BLACK1_HIGH_TRANS }} },
	{ DEPTH_TOP, {{ WHITE1, WHITE1_MED_TRANS }} },
	...
	{ CALC_CEILING_SHALLOW, {{ REDORANGE1_HIGH_TRANS, BLACK1_HIGH_TRANS }} },
	{ CALC_CEILING_DEEP, {{ REDORANGE1_HIGH_TRANS, BLACK1_HIGH_TRANS }} },
