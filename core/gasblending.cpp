...
namespace Blender {
    ...
    std::vector<OutputStep> Blend::getOutputSteps() const {
        ...
        for (const BlendStep& step : steps) {
            ...
            int stepO2Permille = currentO2Vol * 1000 / currentVolume;
            int stepHePermille = currentHeVol * 1000 / currentVolume;
    ...
    bool Blend::correctPressures() {
        //TODO: If tanks are a different size, this will fail to find the correct pressure. We can't just find the average pressure
