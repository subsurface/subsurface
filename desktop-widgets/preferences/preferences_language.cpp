...
PreferencesLanguage::PreferencesLanguage() : AbstractPreferencesWidget(tr("Language"), QIcon::fromTheme("preferences-desktop-locale", QIcon(":preferences-desktop-locale-icon")), 4)
{
