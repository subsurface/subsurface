...
Subsurface zaimportował informacje o miejscach nurkowych, ale może warto poświęcić chwilę na przejrzenia tych danych i upewnienie się, że wszytko wygląda poprawnie.</translation>
    ...
    <message>
        ...
        <translation>Logi nurkowe (*.ssrf *.can *.csv *.db *.sql *.dld *.jlb *.lvd *.sde *.udcf *.uddf *.xml *.txt *.dlf *.apd*.SSRF *.CAN *.CSV *.DB *.SQL *.DLD *.JLB *.LVD *.SDE *.UDCF *.UDDF *.xml *.TXT *.DLF *.APD);;Pliki Cochran (*.can *.CAN);;Pliki CSV (*.csv *.CSV);;Pliki DiveLog.de (*.dld *.DLD);;Pliki JDiveLog (*.jlb *.JLB);;Pliki Liquivision (*.lvd *.LVD);;Pliki MkVI (*.txt *.TXT);;Pliki Suunto (*.sde *.db *.SDE *.DB);;Pliki Divesoft (*.dlf *.DLF);;Pliki UDDF/UDCF (*.uddf *.udcf *.UDDF *.UDCF);;Pliki XML (*.xml *.XML);;Pliki APD (*.apd *.APD);;Pliki Datatrak/WLog (*.log *.LOG);;Pliki OSTCtools (*.dive *.DIVE);;Wszystkie pliki(*)</translation>
    </message>
    <message>
        <location filename="../qt-ui/mainwindow.cpp" line="1851"/>
...
<context>
    ...
    <message>
        ...
        <translation>Masz zamiar zmodyfikować szablon dostarczony przez Subsurface.
</translation>
    </message>
</context>
<context>
