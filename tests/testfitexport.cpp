...
void TestFitExport::testTzResolution()
{
	...
	// device's local UTC offset produced exports that were hours off (T04).
...
void TestFitExport::testTzOverrideAffectsBytes()
{
	...
	// Regression guard for the actual T05 bug: with offset 0 (the new
	// default), the first record's timestamp round-trips to exactly
