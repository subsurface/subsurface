...
{
	connect(SettingsObjectWrapper::instance()->techDetails, &qPrefTec::dcceilingChanged, this, &DiveProfileItem::settingsToggled);
	connect(SettingsObjectWrapper::instance()->techDetails, &qPrefTec::redceilingChanged, this, &DiveProfileItem::settingsToggled);
}
...
DiveHeartrateItem::DiveHeartrateItem()
{
	...
	pen.setWidth(1);
	setPen(pen);
	connect(SettingsObjectWrapper::instance()->techDetails, &qPrefTec::hrgraphChanged, this, &DiveHeartrateItem::setVisible);
}
...
{
	connect(SettingsObjectWrapper::instance()->techDetails, &qPrefTec::percentageGraphChanged, this, &DivePercentageItem::setVisible);
	tissueIndex = i;
	settingsChanged();
}
...
void DiveAmbPressureItem::paint(QPainter *painter, const QStyleOptionGraphicsItem*, QWidget*)
{
	...
	painter->drawPolyline(polygon());
	painter->restore();
	connect(SettingsObjectWrapper::instance()->techDetails, &qPrefTec::percentageGraphChanged, this, &DiveAmbPressureItem::setVisible);
}
...
void DiveMeanDepthItem::paint(QPainter *painter, const QStyleOptionGraphicsItem*, QWidget*)
{
	...
	painter->drawPolyline(polygon());
	painter->restore();
	connect(SettingsObjectWrapper::instance()->techDetails, &qPrefTec::showAverageDepthChanged, this, &DiveAmbPressureItem::setVisible);
}
...
DiveCalculatedCeiling::DiveCalculatedCeiling(ProfileWidget2 *widget) :
	...
	is3mIncrement(false)
{
	connect(SettingsObjectWrapper::instance()->techDetails, &qPrefTec::calcceilingChanged, this, &DiveCalculatedCeiling::setVisible);
...
{
	settingsChanged();
	connect(SettingsObjectWrapper::instance()->techDetails, &qPrefTec::calcalltissuesChanged, this, &DiveCalculatedTissue::setVisible);
	connect(SettingsObjectWrapper::instance()->techDetails, &qPrefTec::calcceilingChanged, this, &DiveCalculatedTissue::setVisible);
}
...
{
	connect(SettingsObjectWrapper::instance()->techDetails, &qPrefTec::dcceilingChanged, this, &DiveReportedCeiling::setVisible);
